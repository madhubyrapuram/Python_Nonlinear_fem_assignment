...
fig.savefig("./displacementDistribution.png",dpi=600,metadata={'Author':"Madhusudhan Reddy Byrapuram"})
...
fig.savefig("./stressDistribution.png",dpi=600,metadata={'Author':"Madhusudhan Reddy Byrapuram"})
...
ax3.legend()
plt.figtext(0.01,0.01,"Plot generated on "+str(datetime.today()),fontsize='small')
fig.savefig("./comparison.png",dpi=600,metadata={'Author':"Madhusudhan Reddy Byrapuram"})
...
plt.figtext(0.01,0.01,"Plot generated on "+str(datetime.today()),fontsize='small')
fig.savefig("./displacement_evolution.png",dpi=600,metadata={'Author':"Madhusudhan Reddy Byrapuram"})